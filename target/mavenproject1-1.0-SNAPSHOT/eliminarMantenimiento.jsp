        ...
        <div class="row">
          <div class="col-sm-12">
            <div class="form-group">  
              ...
              <label class="errorReserva" id="msj"><b>¡ATENCIÓN!</b>&nbsp;Se perderán todos los controles realizados.<br></label>
                ...
                <table class="table display tablamantenimiento">
                  ...
                  <tbody>            
                    ...
                    <tr align="center" >                      
                      ...
                      <td class='vertical' ><input type="checkbox" name='checkbox' disabled="true" onchange="activarBoton()" style="height: 18px;width: 18px;" value='<%= det.getTipo().getId() %>'
                        <% if(det.isCompletado()) { %>
                        checked="checked"
                        <% } %>></td>
                    </tr>                
